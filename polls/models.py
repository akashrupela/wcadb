...
class Countries(models.Model):
    id = models.CharField(primary_key=True, max_length=50)
    name = models.CharField(max_length=50)
    continentid = models.ForeignKey(Continents,on_delete=models.CASCADE,db_column='continentid')
    latitude = models.IntegerField()
    longitude = models.IntegerField()
    zoom = models.SmallIntegerField()
...
class Persons(models.Model):
    primaryid=models.IntegerField(primary_key=True)
...
class Ranksaverage(models.Model):
    ...
    eventid = models.ForeignKey(Events,on_delete=models.CASCADE,db_column='eventid')
    best = models.IntegerField()
    worldrank = models.IntegerField()
    continentrank = models.IntegerField()
    countryrank = models.IntegerField()
    def __str__(self):
        return "Event ID "+str(self.eventid)+" WR "+str(self.worldrank) 
...
class Results(models.Model):
    primaryid=models.IntegerField(primary_key=True)
    competitionid = models.ForeignKey(Competitions,on_delete=models.CASCADE,db_column='competitionid')
    eventid = models.ForeignKey(Events,on_delete=models.CASCADE,db_column='eventid')
    roundid = models.ForeignKey(Rounds,on_delete=models.CASCADE,db_column='roundid')
    pos = models.SmallIntegerField()
    best = models.IntegerField()
    average = models.IntegerField()
    personname = models.CharField(max_length=80, blank=True, null=True)
    personid = models.CharField(max_length=10)
    personcountryid = models.ForeignKey(Countries,on_delete=models.CASCADE,db_column='personcountryid')
    formatid = models.ForeignKey(Formats,on_delete=models.CASCADE,db_column='formatid')
